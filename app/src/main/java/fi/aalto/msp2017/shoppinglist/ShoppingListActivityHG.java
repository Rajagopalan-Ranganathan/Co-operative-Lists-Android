...
public class ShoppingListActivityHG extends AppCompatActivity {
    ...
    private TwoWayGridView gvNotInList,  gvAssigned;
    private TwoWayGridView gvUnassigned;
    private ListItemAdapter notInListItemAdapter, unassignedAdapter, assignedAdapter;
    private static final String LOG_TAG = ShoppingListActivityHG.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shopping_list_hg);
        ...
        gvNotInList = (TwoWayGridView) findViewById(R.id.gvNotInList);
        gvUnassigned = (TwoWayGridView) findViewById(R.id.gvUnassigned);
        gvAssigned = (TwoWayGridView) findViewById(R.id.gvAssigned);
...
//                listItemRef.push().setValue(new ListItem(edit_Title.getText().toString(), null));
        ...
        ((TwoWayGridView) findViewById(R.id.gvAssigned)).setOnItemLongClickListener(new TwoWayAdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(TwoWayAdapterView<?> parent, View view, int position, long id) {
        ...
        ((TwoWayGridView) findViewById(R.id.gvNotInList)).setOnItemClickListener(new TwoWayAdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(TwoWayAdapterView<?> parent, View view, int position, long id) {
                // Get the GridView selected/clicked item text
                Log.d(LOG_TAG,""+position);
                MasterItem selectedItem = (MasterItem) parent.getItemAtPosition(position);
                Toast.makeText(ShoppingListActivityHG.this,selectedItem.getItemName(), Toast.LENGTH_SHORT).show();
    ...
    private void RemoveItemFromList(TwoWayAdapterView<?> parent, int position) {
